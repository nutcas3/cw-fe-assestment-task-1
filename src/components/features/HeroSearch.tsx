...
export function HeroSearch() {
  ...
  return (
    <section 
      className="relative w-full max-w-7xl mx-auto overflow-hidden mt-4 md:mt-8"
    ...
    >
      <div className="relative h-[480px] rounded-2xl overflow-hidden">
        <img 
          ...
          aria-hidden="true" /* Background image doesn't convey content information */
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/40 to-black/70 flex flex-col items-center justify-center px-4 md:px-8">
          <h1 
            id="hero-heading" 
            className="text-4xl md:text-6xl font-bold text-white text-center max-w-4xl mb-8"
          >
